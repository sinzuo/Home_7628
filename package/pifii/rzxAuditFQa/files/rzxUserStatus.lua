    ...
    while(true) do
        ...
        if "0" == isauth then
            ...
            for k,v in pairs(cl)do
                 ...
                 if au then
                     if not hul[mac] then
                         D("auth:1,up:"..v["mac"]..","..v["sign"]..","..v["time"]..","..dl[v["mac"]])
                         local up={}
                         ...
                         up["usr_mac"] = mac 
                         up["onoff_flag"] = "1"
                         up["onoff_time"] = au["start_time"] or os.time()
                         up["nat_port"] = "1000-2000" 
                         up["field_strength"] = v["sign"] or -45
                         user_online(up) 
                     else
                     ...
                     --os.execute("echo \""..v["mac"].." "..dl[mac].." "..v["time"].."\" >> /tmp/rzxuserlist")
                     os.execute("echo \""..v["mac"].." "..dl[mac].." "..v["time"].." "..au["username"]..
