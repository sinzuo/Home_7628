...
if hwtype == "rt2860v2"  or value == "mt7610"  then
	tp = s:taboption("general",
		(#tx_power_list > 0) and ListValue or Value,
...
--	end
	...
	mp = s:taboption("advanced", ListValue, "wsc", translate("WPS Mode"))
	mp:value("", translate("disable"))
	mp:value("pbc", translate("PBC"))
	mp:value("pin", translate("PIN"))
	ml = s:taboption("advanced", Flag, "pbc", translate("WPS PBC"))
	ml:depends({wsc="pbc"})
	ml = s:taboption("advanced", Value, "pin", translate("WPS PIN"))
	ml:depends({wsc="pin"})
...
elseif hwtype == "rt2860v2"  or value == "mt7610"  then
	encr:value("psk", "WPA-PSK")
	encr:value("psk2", "WPA2-PSK")
	encr:value("psk+psk2", "WPA-PSK/WPA2-PSK Mixed Mode")
end
